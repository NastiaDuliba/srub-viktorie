(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".apartments__slider")) new swiper_core_Swiper(".apartments__slider", {
        ...
        if (document.querySelector(".apartaments-mini__slider")) new swiper_core_Swiper(".apartaments-mini__slider", {
            modules: [ Navigation, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
